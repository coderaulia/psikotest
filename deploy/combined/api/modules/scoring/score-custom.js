function resolveNumericValue(option, fallbackValue) {
...
function getResearchBand(averageScore) {
...
export function scoreCustomAssessment({ participantId, definition, answers }) {
    ...
    const summaries = Object.entries(categoryScores).map(([metricKey, score]) => ({
        metricKey,
