...
import { fetchCustomerWorkspaceActivity, fetchCustomerWorkspaceMembers, findCustomerWorkspaceMemberById, issueCustomerWorkspaceMemberInvite, markCustomerWorkspaceMemberNotified, updateCustomerWorkspaceRecord, upsertCustomerWorkspaceMember, } from './site-workspace.repository.js';
...
export async function getCustomerWorkspaceSettings(accountId) {
...
export async function updateCustomerWorkspaceSettings(accountId, input) {
    const account = await requireActiveCustomer(accountId);
...
export async function listCustomerWorkspaceMembers(accountId) {
    const account = await requireActiveCustomer(accountId);
...
function formatActivityDescription(action, metadata) {
    switch (action) {
        case 'customer_assessment.created':
...
export async function getCustomerWorkspaceActivity(accountId, limit = 24) {
    const account = await requireActiveCustomer(accountId);
