...
import { activateCustomerAssessment, addCustomerAssessmentParticipant, completeCustomerAssessmentCheckout, createCustomerAssessment, importCustomerAssessmentParticipants, getCustomerAssessmentDetail, listCustomerAssessmentItems, listCustomerAssessmentParticipants, sendCustomerAssessmentBulkInvites, sendCustomerAssessmentBulkReminders, sendCustomerAssessmentParticipantInvite, sendCustomerAssessmentParticipantReminder, updateCustomerAssessment, } from './site-onboarding.service.js';
...
function requireAssessmentOperator(request) {
    requireCustomerWorkspaceRole(request, ['owner', 'admin', 'operator'], 'Assessment operations are limited to owners, workspace admins, and operators');
}
export const siteOnboardingRoutes = Router();
siteOnboardingRoutes.get('/assessments', asyncHandler(async (request, response) => {
...
siteOnboardingRoutes.get('/assessments/:id', asyncHandler(async (request, response) => {
    if (!request.customerSession) {
        throw new HttpError(401, 'Customer session is required');
    }
...
siteOnboardingRoutes.post('/assessments', asyncHandler(async (request, response) => {
...
siteOnboardingRoutes.patch('/assessments/:id', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
    const payload = assessmentSchema.parse(request.body);
...
siteOnboardingRoutes.post('/assessments/:id/activate', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
    const assessment = await activateCustomerAssessment(request.customerSession.accountId, id);
    response.json(assessment);
}));
siteOnboardingRoutes.post('/assessments/:id/checkout', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
...
siteOnboardingRoutes.get('/assessments/:id/participants', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
    const participants = await listCustomerAssessmentParticipants(request.customerSession.accountId, id);
    response.json(participants);
}));
siteOnboardingRoutes.post('/assessments/:id/participants', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
...
siteOnboardingRoutes.post('/assessments/:id/participants/import', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
...
siteOnboardingRoutes.post('/assessments/:id/participants/send-bulk', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
...
siteOnboardingRoutes.post('/assessments/:id/participants/remind-bulk', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id } = assessmentParamsSchema.parse(request.params);
    const payload = participantBulkSendSchema.parse(request.body ?? {});
...
siteOnboardingRoutes.post('/assessments/:id/participants/:participantId/remind', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
...
siteOnboardingRoutes.post('/assessments/:id/participants/:participantId/send', asyncHandler(async (request, response) => {
    requireAssessmentOperator(request);
    const { id, participantId } = participantParamsSchema.parse(request.params);
    const payload = participantSendSchema.parse(request.body ?? {});
