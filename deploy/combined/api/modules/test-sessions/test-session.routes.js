...
import { createTestSession, getTestSessionById, listTestSessions, updateTestSession, } from './test-session.service.js';
...
testSessionRoutes.get('/', asyncHandler(async (request, response) => {
    const filters = querySchema.parse(request.query);
    response.json({ items: await listTestSessions(filters) });
}));
testSessionRoutes.get('/:id', asyncHandler(async (request, response) => {
...
testSessionRoutes.post('/', asyncHandler(async (request, response) => {
...
testSessionRoutes.patch('/:id', asyncHandler(async (request, response) => {
