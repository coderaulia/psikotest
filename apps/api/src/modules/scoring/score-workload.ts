...
function getWorkloadBand(averageScore: number) {
  if (averageScore <= 2.2) {
    return 'low_workload';
  }
...
export function scoreWorkloadAssessment({ participantId, definition, answers }: ScoreAssessmentContext): ScoredAssessmentResult {
